  ...
  return (
    <>
      ...
      <div className="explination">
        <div className="text">
          <h1>Hi, I'm Brandon, the developer behind PackageSmith.com.</h1>
          <p>
            ...
            but I'm committed to making <i>PackageSmith.com</i> the best it can
            be.
          </p>
          <p>
            ...
            <i> PackageSmith.com</i>.
          </p>
          <p>
            Whether it's a small contribution or a more substantial one, your
            support directly fuels the progress of <i>PackageSmith.com</i>. It
          ...
          <p>
            ...
            effort. With your support, we can take <i>PackageSmith.com</i> to
            new heights.
          </p>
        </div>
        <Coffee />
